            ...
            <div class="form-group">
                ...
                <div class="">
                    <label for="description">Description
                        <textarea class="form-control" type="text" cols="30" rows="10" name="description"
                ...
                <div class="row ">
                    ...
                    <div class="col">
                        <label for="tipo">
                            <select class="form-control">
                                ...
                                <option value="tipo1">Serie</option>
                                <option value="tipo2">Movie</option>
                            </select>
                        </label>
                    </div>
                    <div class="col">
                    ...
                    <div class="form-group mb-2 col">
                        <label for="duration">
                            <input class="form-control" type="number" name="duration" id="duration" placeholder="duration/min">
                        </label>
